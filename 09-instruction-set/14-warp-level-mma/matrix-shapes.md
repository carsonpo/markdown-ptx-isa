...
| mma | | Dense | Floating-point - `.f64` | `.m16n8k4`, `.m16n8k8`, and `.m16n8k16` | PTX ISA version 7.8 |
| mma | | Dense | Floating-point - `.f16` | `.m8n8k4` | PTX ISA version 6.4 |
| mma | | Dense | Floating-point - `.f16` | `.m16n8k8` | PTX ISA version 6.5 |
| mma | | Dense | Floating-point - `.f16` | `.m16n8k16` | PTX ISA version 7.0 |
...
| mma | | Dense | Integer - `.u8`/`.s8` | `.m16n8k16` and `.m16n8k32` | PTX ISA version 7.0 |
