...
![Sparse MMA storage example](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/sparse-mma-storage-example.png)
...
![Sparse MMA metadata example for .f16/.bf16 type](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/f16-metadata-example.png)
...
![Sparse MMA metadata example for .tf32 type](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tf32-metadata-example.png)
...
![Sparse MMA metadata example for .u8/.s8 type](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/u8s8-metadata-example.png)
...
![Sparse MMA metadata example for .u4/.s4 type](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/u4s4-metadata-example.png)
...
![Sparse MMA metadata example for .e4m3/.e5m2/.e3m2/.e2m3/.e2m1 type](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/fp8-metadata-example.png)
...
![Sparse MMA metadata example for .e2m1 type with .kind::mxf4 or .kind::mxf4nvf4](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/fp4-metadata-example.png)
