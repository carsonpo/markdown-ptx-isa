...
| Alternate floating-point format - `.bf16` | Dense | (same shapes as `.f16` above) |
...
| Alternate floating-point format - `.tf32` | Sparse | (same shapes as dense `.tf32` above) |
...
| Floating point - `.f16` | Sparse | (same `.m64nNk32` shapes as `.e4m3`/`.e5m2` above) |
| Alternate floating-point format - `.bf16` | Sparse | (same `.m64nNk32` shapes as `.e4m3`/`.e5m2` above) |
