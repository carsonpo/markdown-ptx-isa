...
- `var[immOff]` — an array element as described in Arrays as Operands.
...
| Source Format | s8 | s16 | s32 | s64 | u8 | u16 | u32 | u64 | f16 | f32 | f64 | bf16 | tf32 |
|---------------|-----|------|------|------|-----|------|------|------|-----|-----|-----|------|------|
...
| Source Format | f16 | f32 | bf16 | e4m3 | e5m2 | e2m3 | e3m2 | e2m1 | ue8m0 | s2f6 |
|---------------|-----|-----|------|------|------|------|------|------|-------|------|
