...
![Hardware Model](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/hardware-model.png)

*Figure 4 Hardware Model — A set of SIMT multiprocessors with on-chip shared memory.*
