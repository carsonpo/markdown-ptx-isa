...
![Grid with CTAs](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/grid-of-ctas.png)

*Figure 1 Grid with CTAs*

![Grid with clusters](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/grid-of-clusters.png)
...
![Memory Hierarchy](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/memory-hierarchy.png)
